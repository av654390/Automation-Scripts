...
#  Program Name:  Procurement\sender.py                                     *
#          Date:  21/06/2024                                                 *
#       version:  1.0.0                                                      *
...
#  2           Developer      NIKHIL CHALIKWAR  nikhil.x.chalikwar@gsk.com   *  
...
def error_mail(lid, err, sid):
    try:
        ...
        msg['To'] = "shiva.x.prasad@gsk.com"
        msg['Cc'] = "shiva.x.prasad@gsk.com"
        msg['Date'] = formatdate(localtime=True)
        msg['Subject'] = f"Logon Error occured in {sid}- AutoSAP Procurement {sid} Post Functional Checks {stamp} {formatdate(localtime=True)}"
                ...
                <tr>
                    <td style="padding: 0; text-align: center;">
                        <div style="background: #F36633; width: 80px; height: 150px; margin: auto; display: flex; align-items: center; justify-content: center;">
                            <strong><span class="content" style="font-size: 24px;">AutoSAP Procurement {sid} Post Functional Checks {stamp}</span></strong>
                        </div>
                    </td>
                </tr>
