...
def db02(nos=0,session=0,path=0,stamp=0, sid=0):
    try:
        print("\n##### DB02 #####")
        ...
        name=f'{nos} {sid} DB02_TableSpace_{stamp}.html'
        ...
        return {"Table Space":db02_dict,"Status":all_status}
