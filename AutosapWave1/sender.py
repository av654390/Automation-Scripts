...
def send_mail(send_from, send_to, send_cc, send_bcc, subject, text, files=None,html=None):
    ...
    for f in os.listdir(files) or []:
        ...
        if fi < 20 and (f.lower().endswith(".html") or f.lower().endswith(".png") or f.lower().endswith(".xlsx") or f.lower().endswith(".txt")):    
...
def error_mail(lid, err, sid):
    try:
        ...
        msg['To'] = "akoju.x.sharanya@gsk.com,erry.8.lavakumar@gsk.com,nikhil.x.chalikwar@gsk.com"
