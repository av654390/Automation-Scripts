...
env = "1.1 - RBP - SAP ERP 6.0(R/3) System"
...
def Autosap(env):
    try:
        ...
        session.findById("wnd[0]/usr/pwdRSYST-BCODE").text = decrypt_aes256(key, cc.aspass)
