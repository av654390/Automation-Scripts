# ****************************************************************************
#  Program Description : Script Performs SAP Logon Action                    *
#  Program Name:  AutosapBASIS\logon.py                                      *
#          Date:  21/06/2024                                                 *
#       version:  1.0.0                                                      *
...
def Autosap(env):
    try:
        ...
        session.findById("wnd[0]/usr/pwdRSYST-BCODE").text = decrypt_aes256(key, cc.elkpass)
        session.findById("wnd[0]").sendVKey(0)
        ...
        return [-1,cc.elkid,"Error in LOGON"+str(e)]
