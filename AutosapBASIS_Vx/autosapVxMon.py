...
def autosapVxMon():
    ...
    try:
        ...
        import logon
        import db01, db02, se38, sm37, sm51, sm58, sm59, smlg, st06, st07, st22
        import sender
        ...
        for i in sid:
            ...
            final_values={'db02_dict':db02_dict,'st06_dict':st06_dict,'st07_dict':st07_dict,'st22_dict':st22_dict,"sm37_dict":sm37_dict,'se38_dict':se38_dict,'sm59_dict':{'value':sealcount,'status':sealstatus}}
            ...
            try:
                ...
                cc = ["sivakaminathan.x.palaniappan@gsk.com","jay.x.menon@gsk.com","amit.k.prabhakar@gsk.com","sunil.k.s@gsk.com","ramakrishnareddy.x.banda@gsk.com","ITTCSESAT@gsk.com","ga&dSAPBASISopsind@gsk.com","anil.x.reddy@gsk.com","erry.8.lavakumar@gsk.com","preetham.x.aranha@gsk.com","akoju.x.sharanya@gsk.com","hareesh.x.s@gsk.com"]
                bcc=["erry.8.lavakumar@gsk.com"]
